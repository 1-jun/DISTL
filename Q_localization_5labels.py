...
def parse_args():
    ...
    parser.add_argument('--ckpt_path', type=str, default='outputs/mimic_5labels/fold2/checkpoint.pth')
...
def load_model(ckpt_path):
    ...
    patch_size, out_dim, n_classes = 8, 65536, 5
...
#%%
# patch_size, out_dim, n_classes = 8, 65536, 5
# ckpt_path = 'outputs/mimic_5labels/fold2/checkpoint.pth'
# CHECKPOINT_KEY = 'student'
...
def main(args):
    ...
    print("True classes: ")
    true_classes = [c for c in true_classes if c in list(LABEL_TO_IND.keys())]
    print(true_classes)
